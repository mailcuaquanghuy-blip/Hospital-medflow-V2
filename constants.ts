...
export const MOCK_PATIENTS: Patient[] = [
  { id: 'p1', name: 'Nguyễn Thị Lan', dob: '1965-05-12', gender: 'Nữ', code: 'BN001', bedNumber: '101', admissionDate: '2024-02-01T08:00', status: PatientStatus.TREATING, admittedByDeptId: 'dept_ngoai' },
  { id: 'p2', name: 'Trần Văn Hùng', dob: '1978-08-20', gender: 'Nam', code: 'BN002', bedNumber: '205', admissionDate: '2024-02-05T09:30', status: PatientStatus.TREATING, admittedByDeptId: 'dept_noi' },
];
