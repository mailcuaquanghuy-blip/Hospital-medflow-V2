...
import { Stethoscope, FlaskConical, HeartPulse, ChevronRight, LayoutGrid, PlusCircle, ShieldCheck, LogOut, Users, Database } from 'lucide-react';
...
export const Dashboard: React.FC<DashboardProps> = ({ departments, onSelectDepartment, onLogout, currentUser, onManageAccounts }) => {
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="flex justify-between items-start">
           <div className="flex items-center gap-4">
              <div>
                 <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Lập và quản lý lịch trình y tế</p>
                 <h2 className="text-xl font-black text-slate-900 tracking-tight uppercase">Hospital medflow</h2>
              </div>
           </div>
