                ...
                >
                  ...
                  <td className="p-4">
                    <span className={`inline-flex items-center gap-1 px-2 py-1 rounded text-xs font-bold ${
                        p.insuranceLevel === '0%' ? 'bg-rose-50 text-rose-700' :
                        p.insuranceLevel === '80%' ? 'bg-orange-50 text-orange-700' :
                        p.insuranceLevel === '95%' ? 'bg-lime-50 text-lime-700' :
