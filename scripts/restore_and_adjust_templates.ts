...
// Full original templates data before any deletion
const ORIGINAL_TEMPLATES_DATA: Record<string, any[]> = {
  ...
  "tmpl_0j4evu9yt": [ // Giường 409 - L19
    ...
    { procedureId: "pr_rj91ghjep", startTime: "09:53", endTime: "10:23", staffId: "s_p085044zx" } // Bùi Thị Thu Hà (Nurse)
  ],
  ...
  "tmpl_1423cfac0": [ // Giường 432 - L23
    ...
    { procedureId: "pr_rj91ghjep", startTime: "14:35", endTime: "15:05", staffId: "s_z83w580hx" } // Nguyễn Tùng Lâm (Doctor -> WILL REMOVE)
  ],
  ...
  "tmpl_246v9mzno": [ // Giường 429 - L20
    ...
    { procedureId: "pr_rj91ghjep", startTime: "13:32", endTime: "14:02", staffId: "s_z83w580hx" } // Doctor -> WILL REMOVE
  ],
  "tmpl_3jg6x4rri": [ // Giường 401 - L12
    ...
    { procedureId: "pr_rj91ghjep", startTime: "14:03", endTime: "14:33", staffId: "s_c025m4y4p" } // Lò Thị Thanh (Nurse)
  ],
  ...
  "tmpl_7aaz3ro3f": [ // Giường 402 - L35
    ...
    { procedureId: "pr_rj91ghjep", startTime: "14:04", endTime: "14:34", staffId: "s_w8k2iebit" } // Vũ Thúy Hà (Nurse)
  ],
  "tmpl_7i41bijz6": [ // Giường 439 - L16
    ...
    { procedureId: "pr_rj91ghjep", startTime: "09:15", endTime: "09:45", staffId: "s_c025m4y4p" } // Lò Thị Thanh (Nurse)
  ],
  "tmpl_7zd39v48g": [ // L29
    ...
    { procedureId: "pr_rj91ghjep", startTime: "15:38", endTime: "16:08", staffId: "s_z83w580hx" } // Doctor -> WILL REMOVE
  ],
  ...
  "tmpl_8tnrneh1v": [ // Giường 434 - L35
    ...
    { procedureId: "pr_rj91ghjep", startTime: "07:47", endTime: "08:17", staffId: "s_w8k2iebit" } // Vũ Thúy Hà (Nurse)
  ],
  ...
  "tmpl_ailxcwuzj": [ // Giường 470 - L04
    ...
    { procedureId: "pr_rj91ghjep", startTime: "08:19", endTime: "08:49", staffId: "s_p085044zx" } // Bùi Thị Thu Hà (Nurse)
  ],
  ...
  "tmpl_bj2z9k2tg": [ // Giường 461 - L03
    ...
    { procedureId: "pr_rj91ghjep", startTime: "15:40", endTime: "16:10", staffId: "s_w8k2iebit" } // Vũ Thúy Hà (Nurse)
  ],
  "tmpl_bx0121uic": [ // Giường 423 - L26
    ...
    { procedureId: "pr_rj91ghjep", startTime: "14:03", endTime: "14:33", staffId: "s_z83w580hx" } // Doctor -> WILL REMOVE
  ],
  "tmpl_cj3xl8br0": [ // Giường 446 - L06
    ...
    { procedureId: "pr_rj91ghjep", startTime: "15:07", endTime: "15:37", staffId: "s_c025m4y4p" } // Lò Thị Thanh (Nurse)
  ],
  ...
  "tmpl_e5ffehyxv": [ // Giường 451 - L10
    ...
    { procedureId: "pr_rj91ghjep", startTime: "08:50", endTime: "09:20", staffId: "s_p085044zx" } // Bùi Thị Thu Hà (Nurse)
  ],
  "tmpl_efnqvpusw": [ // Giường 472 - L06
    ...
    { procedureId: "pr_rj91ghjep", startTime: "08:19", endTime: "08:49", staffId: "s_w8k2iebit" } // Vũ Thúy Hà (Nurse)
  ],
  "tmpl_fg3ux14em": [ // Giường 443 - L04
    ...
    { procedureId: "pr_rj91ghjep", startTime: "16:12", endTime: "16:42", staffId: "s_w8k2iebit" } // Vũ Thúy Hà (Nurse)
  ],
  "tmpl_fmqobzm6e": [ // L47
    ...
    { procedureId: "pr_rj91ghjep", startTime: "10:25", endTime: "10:55", staffId: "s_p085044zx" } // Bùi Thị Thu Hà (Nurse)
  ],
  "tmpl_frpduhguw": [ // Giường 458 - L11
    { procedureId: "pr_eqnn4i152", startTime: "14:31", endTime: "14:56", staffId: "s_j70mhmvcl" },
    { procedureId: "pr_yosjw3y2w", startTime: "15:06", endTime: "15:31", staffId: "s_1yclzxcef" },
    { procedureId: "pr_rj91ghjep", startTime: "16:45", endTime: "17:15", staffId: "s_c025m4y4p" } // Lò Thị Thanh (Nurse)
  ],
  "tmpl_fsvszahfk": [ // Giường 447 - L07
    { procedureId: "pr_eqnn4i152", startTime: "13:43", endTime: "14:08", staffId: "s_j70mhmvcl" },
    { procedureId: "pr_yosjw3y2w", startTime: "14:17", endTime: "14:42", staffId: "s_1yclzxcef" },
    { procedureId: "pr_rj91ghjep", startTime: "13:32", endTime: "14:02", staffId: "s_c025m4y4p" } // Lò Thị Thanh (Nurse)
  ],
  "tmpl_gz9r767gs": [ // Giường 459 - L01
    { procedureId: "pr_eqnn4i152", startTime: "13:31", endTime: "13:56", staffId: "s_j70mhmvcl" },
    { procedureId: "pr_yosjw3y2w", startTime: "14:03", endTime: "14:28", staffId: "s_1yclzxcef" },
    { procedureId: "pr_rj91ghjep", startTime: "14:36", endTime: "15:06", staffId: "s_w8k2iebit" } // Vũ Thúy Hà (Nurse)
  ],
  "tmpl_h1qdfjaqa": [ // Giường 430 - L21
    ...
    { procedureId: "pr_rj91ghjep", startTime: "16:43", endTime: "17:13", staffId: "s_z83w580hx" } // Doctor -> WILL REMOVE
  ],
  "tmpl_iq8mbg3dh": [ // L32
  ...
  "tmpl_jrdiy03a2": [ // Giường 435 - L14
    ...
    { procedureId: "pr_rj91ghjep", startTime: "07:48", endTime: "08:18", staffId: "s_p085044zx" } // Bùi Thị Thu Hà (Nurse)
  ],
  ...
  "tmpl_kiu2lswc6": [ // Giường 454 - L08
    ...
    { procedureId: "pr_rj91ghjep", startTime: "13:32", endTime: "14:02", staffId: "s_w8k2iebit" } // Vũ Thúy Hà (Nurse)
  ],
  "tmpl_kxubo1ud4": [ // Giường 411 - L21
    ...
    { procedureId: "pr_rj91ghjep", startTime: "09:47", endTime: "10:17", staffId: "s_c025m4y4p" } // Lò Thị Thanh (Nurse)
  ],
  ...
  "tmpl_nz8casmri": [ // Giường 424 - L27
    ...
    { procedureId: "pr_rj91ghjep", startTime: "15:40", endTime: "16:10", staffId: "s_lbf6qsiya" } // Cà Thị Oanh (Nurse)
  ],
  "tmpl_o0ku37u4i": [ // Giường 433 - L24
    { procedureId: "pr_eqnn4i152", startTime: "15:54", endTime: "16:19", staffId: "s_j70mhmvcl" },
    { procedureId: "pr_yosjw3y2w", startTime: "16:25", endTime: "16:50", staffId: "s_1yclzxcef" },
    { procedureId: "pr_rj91ghjep", startTime: "15:07", endTime: "15:37", staffId: "s_z83w580hx" } // Doctor -> WILL REMOVE
  ],
  "tmpl_o3ew09258": [ // Giường 419 - L29
    ...
    { procedureId: "pr_rj91ghjep", startTime: "10:20", endTime: "10:50", staffId: "s_c025m4y4p" } // Lò Thị Thanh (Nurse)
  ],
  "tmpl_opduk66vt": [ // Giường 471 - L05
    ...
    { procedureId: "pr_rj91ghjep", startTime: "08:12", endTime: "08:42", staffId: "s_c025m4y4p" } // Lò Thị Thanh (Nurse)
  ],
  "tmpl_oyvlgyyav": [ // Giường 457 - L10
    ...
    { procedureId: "pr_rj91ghjep", startTime: "16:12", endTime: "16:42", staffId: "s_c025m4y4p" } // Lò Thị Thanh (Nurse)
  ],
  "tmpl_qjc4qzs9i": [ // Giường 410 - L20
    ...
    { procedureId: "pr_rj91ghjep", startTime: "09:54", endTime: "10:24", staffId: "s_w8k2iebit" } // Vũ Thúy Hà (Nurse)
  ],
  "tmpl_seq29glqd": [ // Giường 467 - L01
    ...
    { procedureId: "pr_rj91ghjep", startTime: "10:57", endTime: "11:27", staffId: "s_p085044zx" } // Bùi Thị Thu Hà (Nurse)
  ],
  "tmpl_sqgmmwe6y": [ // Giường 403 - L14
    ...
    { procedureId: "pr_rj91ghjep", startTime: "13:32", endTime: "14:02", staffId: "s_lbf6qsiya" } // Cà Thị Oanh (Nurse)
  ],
  "tmpl_svmbz6cac": [ // Giường 438 - L15
    ...
    { procedureId: "pr_rj91ghjep", startTime: "09:22", endTime: "09:52", staffId: "s_w8k2iebit" } // Vũ Thúy Hà (Nurse)
  ],
  "tmpl_sx7xp5nop": [ // Giường 414 - L24
    ...
    { procedureId: "pr_rj91ghjep", startTime: "10:26", endTime: "10:56", staffId: "s_w8k2iebit" } // Vũ Thúy Hà (Nurse)
  ],
  "tmpl_sxov9eyjp": [ // Giường 449 - L08
    ...
    { procedureId: "pr_rj91ghjep", startTime: "08:44", endTime: "09:14", staffId: "s_c025m4y4p" } // Lò Thị Thanh (Nurse)
  ],
  "tmpl_t0khkex45": [ // Giường 415 - L25
    ...
    { procedureId: "pr_rj91ghjep", startTime: "10:55", endTime: "11:25", staffId: "s_z83w580hx" } // Doctor -> WILL REMOVE
  ],
  "tmpl_t7czocj2w": [ // Giường 405 - L16
    ...
    { procedureId: "pr_rj91ghjep", startTime: "16:12", endTime: "16:42", staffId: "s_lbf6qsiya" } // Cà Thị Oanh (Nurse)
  ],
  ...
  "tmpl_vx14c6nm1": [ // Giường 460 - L02
    ...
    { procedureId: "pr_yosjw3y2w", startTime: "14:10", endTime: "14:35", staffId: "s_1yclzxcef" },
    { procedureId: "pr_rj91ghjep", startTime: "15:08", endTime: "15:38", staffId: "s_w8k2iebit" } // Vũ Thúy Hà (Nurse)
  ],
  "tmpl_w5fj92g85": [ // Giường 422 - L25
    ...
    { procedureId: "pr_rj91ghjep", startTime: "14:35", endTime: "15:05", staffId: "s_c025m4y4p" } // Lò Thị Thanh (Nurse)
  ],
  "tmpl_wjt0bj8g8": [ // Giường 406 - L17
    ...
    { procedureId: "pr_rj91ghjep", startTime: "16:10", endTime: "16:40", staffId: "s_z83w580hx" } // Doctor -> WILL REMOVE
  ],
  "tmpl_xp78xlmrv": [ // Giường 444 - L05
    ...
    { procedureId: "pr_rj91ghjep", startTime: "16:45", endTime: "17:15", staffId: "s_w8k2iebit" } // Vũ Thúy Hà (Nurse)
  ],
  "tmpl_xx6jfquau": [ // Giường 455 - L09
    ...
    { procedureId: "pr_rj91ghjep", startTime: "15:39", endTime: "16:09", staffId: "s_c025m4y4p" } // Lò Thị Thanh (Nurse)
  ],
  ...
  "tmpl_yj1ulmx3i": [ // Giường 450 - L09
    ...
    { procedureId: "pr_rj91ghjep", startTime: "08:50", endTime: "09:20", staffId: "s_w8k2iebit" } // Vũ Thúy Hà (Nurse)
  ],
  "tmpl_zd1y6v4bv": [ // Giường 420 - L47
    ...
    { procedureId: "pr_rj91ghjep", startTime: "10:55", endTime: "11:25", staffId: "s_c025m4y4p" } // Lò Thị Thanh (Nurse)
  ],
  "tmpl_zmf0tzqmv": [ // Giường 442 - L18
    ...
    { procedureId: "pr_rj91ghjep", startTime: "09:22", endTime: "09:52", staffId: "s_p085044zx" } // Bùi Thị Thu Hà (Nurse)
  ],
  "tmpl_zmzdlow75": [ // Giường 469 - L03
    ...
    { procedureId: "pr_rj91ghjep", startTime: "10:58", endTime: "11:28", staffId: "s_w8k2iebit" } // Vũ Thúy Hà (Nurse)
  ]
};

async function processRestoreAndAdjust() {
  ...
  console.log(`Found ${dbTemplates.length} templates in Firestore.`);

  // Step 1: Re-construct procedures for each template, removing ONLY Doctor Xoa Bóp
  ...
  const preparedTemplates = dbTemplates.map(t => {
    ...
    const filteredProcs = origProcs.filter((p: any) => {
      ...
      if (isDoctor) {
        ...
        console.log(`[REMOVE] Doctor Xoa bóp: Template "${t.name}" | Staff: ${staffObj?.name || p.staffId}`);
        return false;
      } else {
        nurseXoaBopKeptCount++;
        console.log(`[KEEP] Nurse Xoa bóp: Template "${t.name}" | Staff: ${staffObj?.name || p.staffId}`);
        return true;
      }
    }).map((p: any) => ({ ...p }));
  ...
  console.log(`\nFiltered: Removed ${doctorXoaBopRemovedCount} Doctor Xoa Bóp; Kept ${nurseXoaBopKeptCount} Nurse Xoa Bóp.`);

  // Step 2: Extract all procedure items for conflict detection & minimal shift adjustment
  interface ProcItem {
    templateId: string;
    templateName: string;
    procIndex: number;
  ...
  preparedTemplates.forEach(t => {
    t.procedures.forEach((p: any, idx: number) => {
      ...
      if (p.procedureId === 'pr_eqnn4i152' || procName.includes('Điện châm')) {
        ...
        busyStartOffset = 0;
        busyEndOffset = 30; // 30 mins busy for Nurse
      }
  ...
  // Adjust sequentially with MINIMAL shift (+1m buffer)
  staffSessionMap.forEach((items, key) => {
    ...
    for (let i = 0; i < items.length - 1; i++) {
      ...
      const minRequiredBusyStart = prev.busyEndAbs + 1; // 1 min buffer

      if (next.busyStartAbs < minRequiredBusyStart) {
        const neededBusyStartAbs = minRequiredBusyStart;
        const newStartMins = neededBusyStartAbs - next.busyStartOffset;
        const delta = newStartMins - next.startMins;

        console.log(`Shifting [${prev.staffName}]: Template "${next.templateName}" [${next.procName}]: ${next.startTime} -> +${delta}m -> new ${minutesToTime(newStartMins)}`);
  ...
  console.log(`Conflicts remaining: ${conflictsCount}`);

  // CHECK TIME BOUNDS (Morning: 07:30 - 11:30, Afternoon: 13:00 - 17:30)
  console.log("\n=== VERIFYING TIME BOUNDS ===");
  ...
  console.log(`Out of bounds remaining: ${outOfBoundsCount}`);

  if (conflictsCount === 0 && outOfBoundsCount === 0) {
    console.log("\n✅ ALL VALIDATIONS PASSED! UPDATING FIRESTORE TEMPLATES...");
    let updateCount = 0;
    ...
    console.log(`🎉 SUCCESS! Updated ${updateCount} templates in Firestore!`);
  } else {
    console.log("⚠️ Please check conflicts or out of bounds before updating.");
  }
}

processRestoreAndAdjust().then(() => process.exit(0)).catch(e => { console.error(e); process.exit(1); });
