...
const supabase = createClient("https://chavuvjjrimdeomjexej.supabase.co", "sb_publishable_sqTxQqDBQA6D9e35A0vq5w_JNFXAJ6a");

const rawInput = `
Họ tên bệnh nhân,Nam,Nữ,Ngày giờ bắt đầu,Ngày giờ kết thúc,Người thực hiện
